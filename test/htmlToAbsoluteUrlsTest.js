...
test("Changes a link href", async t => {
  t.is((await htmlToAbsUrls(`<a href="#testanchor">Hello</a>`, "http://example.com/")).html, `<a href="http://example.com/#testanchor">Hello</a>`);
  t.is((await htmlToAbsUrls(`<a href="#testanchor">Hello</a>`, "http://example.com/web/")).html, `<a href="http://example.com/web/#testanchor">Hello</a>`);
